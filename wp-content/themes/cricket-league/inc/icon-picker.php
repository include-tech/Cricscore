...
class Cricket_League_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'cricket-league' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $cricket_league_font_awesome_icon_array = cricket_league_font_awesome_icon_array();
                    foreach ($cricket_league_font_awesome_icon_array as $cricket_league_font_awesome_icon) {
                            $icon_class = $this->value() == $cricket_league_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($cricket_league_font_awesome_icon).'"></i>
                            <span class="cricket-league-social-class">'.esc_attr($cricket_league_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function cricket_league_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'cricket-league-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'cricket_league_customizer_script' );

if(!function_exists('cricket_league_font_awesome_icon_array')){
    function cricket_league_font_awesome_icon_array(){
