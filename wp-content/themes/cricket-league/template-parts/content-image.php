        ...
        <article class="new-text <?php if(has_post_thumbnail() && get_theme_mod( 'cricket_league_featured_image_hide_show',true) == 1) { ?>col-lg-6 col-md-6" <?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
          ...
          <?php if( get_theme_mod('cricket_league_button_text','Read More') != ''){ ?>
            <div class="more-btn mt-4 mb-4">
              <a class="p-3" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('cricket_league_button_text',__('Read More','cricket-league')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('cricket_league_button_text',__('Read More','cricket-league')));?></span><span class="top-icon"></span></a>
            </div>
          <?php } ?>
        </article>
      </div>
